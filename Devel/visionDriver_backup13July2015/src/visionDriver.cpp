	...
	//		    cout << currentFaceRect.width << " h=" << currentFaceRect.height << endl;
			    ...
			    if (boundingBox.size()>1)
			    {
                    ...
                    if (rightArmInd!=leftArmInd)
                    {
				        ...
				        utilsObj->drawRotatedRect(captureFrameFace, armRotatedRects[leftArmInd], Scalar(0,0,255));
				        ...
				        utilsObj->drawRotatedRect(captureFrameFace, armRotatedRects[rightArmInd], Scalar(0,0,255));

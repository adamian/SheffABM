...
//    int camNum = parser.get<int>(0);
    ...
    string imageInPort;
    BufferedPort< ImageOf<PixelRgb> > objectTrack;	
    bool inOpen;
    bool isCameraOpen;
	    
	imageInPort = "/objectTracking:i";
	isCameraOpen = objectTrack.open(imageInPort.c_str());
    ...
    while(1)
    {
    	inCount = objectTrack.getInputCount();
    if( inCount == 0 )
    {
...
//    {
        ...
        {
//            cap >> frame;
    	    ImageOf<PixelRgb> *yarpImage = objectTrack.read();

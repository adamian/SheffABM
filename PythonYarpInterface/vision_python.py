...
def connectPorts():
    if not( yarp.Network.connect("/imout", "/interface/cam/right") ):
        return False
...
def disconnectPorts():
    yarp.Network.disconnect("/imout", "/interface/cam/right")
